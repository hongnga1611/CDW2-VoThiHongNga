...
$url_path = str_replace('\\', '/', $url_path);
    ...
    $styles = $scss->compile('@import "28-styles.scss";');

    $css = fopen('css/28-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/28-styles.css" rel="stylesheet" type="text/css" />
